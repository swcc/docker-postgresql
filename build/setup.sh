...
if [ ! -f /var/lib/postgresql/9.3/main/PG_VERSION ] && [ "$DATABASE_NAME" ] && [ "$DATABASE_USER" ] && [ "$DATABASE_PASSWORD" ]
then
    # Create postgres data directory
    rm -rf   /var/lib/postgresql/9.3/main
    mkdir -p /var/lib/postgresql/9.3/main
    chown -R postgres:postgres /var/lib/postgresql/
    /sbin/setuser postgres /usr/lib/postgresql/9.3/bin/initdb /var/lib/postgresql/9.3/main/
    ...
    # Stop postgresql
    /usr/bin/pg_ctlcluster "9.3" main stop
fi
